...
public class EntityAraiguma extends EntityAnimal {

	/** The time until the next egg is spawned. */
	public EntityAraiguma(World world) {
		super(world);
...
//		this.tasks.addTask(5, new EntityAITempt(this, 1.0D, Items.wheat_seeds, false));
	...
	@Override
		public boolean isEntityApplicable(Entity p_82704_1_) {
			return p_82704_1_ instanceof EntityAraiguma;
		}
	};
	//繁殖
	protected EntityLiving createInstance() {
		return new EntityAraiguma(this.worldObj);
	}
...
*/
    public EntityAraiguma createChild(EntityAgeable p_90011_1_)
    {
        return new EntityAraiguma(this.worldObj);
    }
...
@SideOnly(Side.CLIENT)
    public boolean interact(EntityPlayer p_70085_1_) {
        	...
        	p_70085_1_.getCurrentArmor(3) != null && armor3.getItem() == TanoshiItemCore.ParkBoushi)
        {
            ...
            setDead();
            EntityAraisan entityAraiguma = new EntityAraisan(worldObj);
            entityAraiguma.setLocationAndAngles(posX, posY, posZ, rotationYaw, rotationPitch);
            entityAraiguma.setHealth(this.getHealth());
            entityAraiguma.renderYawOffset = renderYawOffset;
            worldObj.spawnEntityInWorld(entityAraiguma);
