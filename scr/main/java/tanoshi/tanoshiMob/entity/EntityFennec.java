...
public class EntityFennec extends EntityFriends {

	/** The time until the next egg is spawned. */
	public EntityFennec(World world) {
		super(world);
...
//		this.tasks.addTask(5, new EntityAITempt(this, 1.0D, Items.wheat_seeds, false));
	...
	protected EntityLiving createInstance() {
		return new EntityFennec(this.worldObj);
	}
...
*/
	@Override
    public EntityFennec createChild(EntityAgeable p_90011_1_)
    {
        return new EntityFennec(this.worldObj);
    }
