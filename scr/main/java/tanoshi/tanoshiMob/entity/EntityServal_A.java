...
public class EntityServal_A extends EntityAnimal {

	/** The time until the next egg is spawned. */
	public EntityServal_A(World world) {
		super(world);
...
//		this.tasks.addTask(5, new EntityAITempt(this, 1.0D, Items.wheat_seeds, false));
	...
	@Override
		public boolean isEntityApplicable(Entity p_82704_1_) {
			return p_82704_1_ instanceof EntityServal_A;
		}
	};
	//繁殖
	protected EntityLiving createInstance() {
		return new EntityServal_A(this.worldObj);
	}
...
*/
    public EntityServal_A createChild(EntityAgeable p_90011_1_)
    {
        return new EntityServal_A(this.worldObj);
    }
...
@SideOnly(Side.CLIENT)
    public boolean interact(EntityPlayer p_70085_1_) {
        	...
        	p_70085_1_.getCurrentArmor(3) != null && armor3.getItem() == TanoshiItemCore.ParkBoushi)
        {
            ...
            setDead();
            EntityServal entityserval = new EntityServal(worldObj);
            entityserval.setLocationAndAngles(posX, posY, posZ, rotationYaw, rotationPitch);
            entityserval.setHealth(this.getHealth());
            entityserval.renderYawOffset = renderYawOffset;
            worldObj.spawnEntityInWorld(entityserval);
