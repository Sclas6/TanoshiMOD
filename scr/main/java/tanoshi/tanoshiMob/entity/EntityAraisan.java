...
public class EntityAraisan extends EntityFriends {

	/** The time until the next egg is spawned. */
	public EntityAraisan(World world) {
		super(world);
...
//		this.tasks.addTask(1, new EntityAIPanic(this, 1.5D));
      ...
      //迢ｬ閾ｪAI 繝代�ｼ繧ｯ繧ｬ繧､繝峨�ｮ蟶ｽ蟄占｣�蛯吶�励Ξ繧､繝､繝ｼ繧定ｿｽ縺�縺九￠繧� entity speed 1.2
        this.tasks.addTask(5, new EntityAIGuide(this, 1.1F));
	}
	...
	protected EntityLiving createInstance() {
		return new EntityAraisan(this.worldObj);
	}
...
*/
	@Override
    public EntityAraisan createChild(EntityAgeable p_90011_1_)
    {
        return new EntityAraisan(this.worldObj);
    }
