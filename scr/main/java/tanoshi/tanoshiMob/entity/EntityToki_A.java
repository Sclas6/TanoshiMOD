...
public class EntityToki_A extends EntityChicken {

	/** The time until the next egg is spawned. */
	public EntityToki_A(World world) {
		super(world);
...
//		this.tasks.addTask(5, new EntityAITempt(this, 1.0D, Items.wheat_seeds, false));
	...
	@Override
		public boolean isEntityApplicable(Entity p_82704_1_) {
			return p_82704_1_ instanceof EntityToki_A;
		}
	};
	//繁殖
	protected EntityLiving createInstance() {
		return new EntityToki_A(this.worldObj);
	}
...
*/
    public EntityToki_A createChild(EntityAgeable p_90011_1_)
    {
        return new EntityToki_A(this.worldObj);
    }
...
@SideOnly(Side.CLIENT)
    public boolean interact(EntityPlayer p_70085_1_) {
        	...
        	p_70085_1_.getCurrentArmor(3) != null && armor3.getItem() == TanoshiItemCore.ParkBoushi)
        {
            ...
            setDead();
            EntityToki entitytoki = new EntityToki(worldObj);
            entitytoki.setLocationAndAngles(posX, posY, posZ, rotationYaw, rotationPitch);
            entitytoki.setHealth(this.getHealth());
            entitytoki.renderYawOffset = renderYawOffset;
            worldObj.spawnEntityInWorld(entitytoki);
