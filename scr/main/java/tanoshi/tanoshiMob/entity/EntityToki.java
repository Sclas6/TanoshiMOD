...
public class EntityToki extends EntityChicken{

	/** The time until the next egg is spawned. */
	public EntityToki(World world) {
		super(world);
...
//		this.tasks.addTask(5, new EntityAITempt(this, 1.0D, Items.wheat_seeds, false));
	...
	@Override
		public boolean isEntityApplicable(Entity p_82704_1_) {
			return p_82704_1_ instanceof EntityToki;
		}
	};
	//繁殖
	protected EntityLiving createInstance() {
		return new EntityToki(this.worldObj);
	}
...
*/
    public EntityToki createChild(EntityAgeable p_90011_1_)
    {
        return new EntityToki(this.worldObj);
    }
